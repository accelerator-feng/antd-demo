...
export default class PCHeader extends React.Component {
    ...
    render() {
        const userShow = this.props.hasLogined ? <Menu.Item key="logout"  className="ant-menu-item register">
      <Button type="primary" htmlType="button">{this.props.userNickName}</Button>{'  '}
      <Button type="dashed" htmlType="button">个人中心</Button>{'  '}
      <Button type="dashed" htmlType="button" onClick={this.props.logout}>退出</Button>
      </Menu.Item> :

...
class MyModal extends React.Component {
    ...
    handleSubmit=(e) => {
        ...
        this.props.form.validateFields(state.field[state.action], {}, (err, values) => {
    ...
    render() {
        ...
        return (
            <Modal title="用户中心" wrapClassName="vertical-center-modal" visible={this.props.modalVisible} onCancel={this.handleCancel} footer={[
